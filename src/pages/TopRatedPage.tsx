    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl sm:text-4xl font-black text-white">Top Películas Mejor Valoradas</h1>
            <p className="text-xs sm:text-sm text-slate-400">
              Las obras maestras del cine con mayor puntuación según millones de espectadores en TMDb
            </p>
          </div>
        </div>
      </div>
